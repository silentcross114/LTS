    ...
    render: function () {
      ...
      return (
        React.createElement("div", {className: "testAnswerListItem"}, 
          ...
          React.createElement("div", {className: "testAnswerListText", onClick: this.selectThisAnswer}, 
    ...
    render: function () {
      ...
      if (this.props.Material.Medium) {
        if (this.props.Material.Medium.MediumType == 1) {
          //audio
          material = (React.createElement(AudioPlayer, {mediumUrl: this.props.Material.Medium.url, mediumId: this.props.Material.Medium.MediumId}));
        }
        else {
          //picture
      ...
      var question;
      if (this.props.QuestionText.Material) {
