...
window.onload = function () {
  ...
  var Timer = React.createClass({displayName: "Timer",
    ...
    render: function () {
      return (React.createElement("div", {className: "topRemainTime"}, SecondsToMMSS(this.state.timeLimit)))
    },
      ...
      this.setState({
        ...
        timer: setInterval(function () {
          ...
          if (state.timeLimit == 0) {
            ...
            timeout = true;
            this.props.timeoutCallBack(false);
          }
          else {
            state.timeLimit--;
            this.setState(state)
    ...
    render: function () {
      ...
      return (
        React.createElement("div", {className: "topArea"}, 
          ...
          React.createElement(Timer, {timeLimit: this.props.timeLimit, timeoutCallBack: this.props.timeoutCallBack})
        )
      );
    }
  });
    ...
    render: function () {
      ...
      return (
        React.createElement("div", {className: "testConfirm"}, 
          React.createElement("div", {className: "btnConfirm", onClick: this.props.onSubmit(true)}, 
            "Next"
          )
        )
      );
  ...
  var Question = React.createClass({displayName: "Question",
    ...
    render: function () {
      ...
      var headerData = {
        ...
        timeoutCallBack : this.submitAnswer
      };
    ...
    submitAnswer: function (fetchNext) {
      var self = this;
      var testId = $('#testId').val();
      var interfaceLanguage = $('#interfaceLanguage').val();
      ...
      $.post(url, { testId: testId, questionId: questionId, userAnswerIndex: userSelect, interfaceLanguage: interfaceLanguage, fetchNext :fetchNext }).done(function (data) {
        //in case of auto submit, next question is not fetched
        if(fetchNext == false){          
          return;
        }
