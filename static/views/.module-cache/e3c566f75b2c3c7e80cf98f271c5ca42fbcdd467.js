...
var welcome = React.createClass({displayName: "welcome",
    render: function () {
        ...
        if (this.props.started) {
            welcomeBody = React.createElement(WelcomeContinue, {stringResource: this.props.stringResource, startTest: this.startTest});
        }
        else {
            welcomeBody = React.createElement(WelcomeNewTest, {stringResource: this.props.stringResource, startTest: this.startTest});
        }
            ...
            return (
                React.createElement("div", {className: "contentArea"}, 
                    React.createElement("div", {className: "informationArea"}, 
                        ...
                        React.createElement("div", {id: "btnStart", className: "buttonArea", onclick: this.props.startTest}, React.createElement("a", {
