...
var welcome = React.createClass({displayName: "welcome",
    render: function () {
        ...
        if (this.props.started) {
            welcomeBody = React.createElement(WelcomeContinue, {stringResource: this.props.stringResource, startTest: startTest});
        }
        else {
            welcomeBody = React.createElement(WelcomeNewTest, {stringResource: this.props.stringResource, startTest: startTest});
        }
